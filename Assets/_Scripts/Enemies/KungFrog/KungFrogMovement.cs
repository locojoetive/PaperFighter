...
public class KungFrogMovement : MonoBehaviour {
    ...
    private void Jump()
    {
        ...
        FindObjectOfType<AudioManager>().PlaySound("kfJump", 1F);
    }
    ...
    public void SpawnGlove()
    {
        ...
        gloveClone.transform.localScale = SimpleMath.PointwiseMultiply(gloveClone.transform.localScale, new Vector3(facingRight ? 1F : -1F, 1F, 1F));
    }
}
